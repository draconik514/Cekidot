<?php
// kirim-surat.php - Halaman Kirim Surat
session_start();
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nomor_surat) || empty($perihal) || empty($asal) || empty($tanggal_surat) || empty($nama_pengirim) || empty($no_hp)) {
        ...
        if (isset($_FILES['file']) && $_FILES['file']['error'] == 0) {
            ...
            if (!in_array($file_ext, $allowed)) {
                $error = 'Format file tidak didukung! Gunakan PDF, DOC, XLS, JPG, PNG, dll.';
            } elseif ($_FILES['file']['size'] > $max_size) {
                $error = 'Ukuran file maksimal 5MB!';
            } else {
                $file_name = time() . '_' . preg_replace('/[^a-zA-Z0-9._-]/', '', $_FILES['file']['name']);
                $upload_path = 'uploads/surat/' . $file_name;
        ...
        if (empty($error)) {
            ...
            $stmt = $pdo->prepare("INSERT INTO surat_masuk (nomor_surat, tanggal_surat, asal_instansi, nama_pengirim, no_hp, perihal, keterangan, file_surat, ip_address) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
            
            if ($stmt->execute([$nomor_surat, $tanggal_surat, $asal, $nama_pengirim, $no_hp, $perihal, $keterangan, $file_name, $ip])) {
                $success = true;
            } else {
...
document.addEventListener('DOMContentLoaded', function() {
    document.title = 'Kirim Surat - CEKIDOT';
});
</script>

<style>
    /* ============================================================
       HALAMAN KIRIM SURAT - PREMIUM & ELEGAN
       ============================================================ */
    ...
    .file-preview-wrapper .file-detail {
        flex: 1;
        min-width: 0;
    }
            ...
            <div class="alert alert-success">
                ...
                <div>
                    ...
                    <p style="font-size:13px; color:#047857;">
                        <i class="fas fa-info-circle"></i> Nomor Surat: <strong><?= htmlspecialchars($nomor_surat) ?></strong>
                    </p>
                    <a href="kirim-surat.php" class="btn-kirim-lagi">
            ...
            <form method="post" enctype="multipart/form-data" id="formKirimSurat" novalidate>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="text" name="asal" id="asal" placeholder="Masukkan nama instansi atau perusahaan" required value="<?= isset($_POST['asal']) ? htmlspecialchars($_POST['asal']) : '' ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_pengirim" id="namaPengirim" placeholder="Masukkan nama lengkap" required value="<?= isset($_POST['nama_pengirim']) ? htmlspecialchars($_POST['nama_pengirim']) : '' ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" name="no_hp" id="noHp" placeholder="Contoh: 081234567890" required value="<?= isset($_POST['no_hp']) ? htmlspecialchars($_POST['no_hp']) : '' ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nomor_surat" id="nomorSurat" placeholder="Contoh: 001/DISPAR/07/2026" required value="<?= isset($_POST['nomor_surat']) ? htmlspecialchars($_POST['nomor_surat']) : '' ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_surat" id="tanggalSurat" required value="<?= isset($_POST['tanggal_surat']) ? htmlspecialchars($_POST['tanggal_surat']) : date('Y-m-d') ?>">
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="text" name="perihal" id="perihal" placeholder="Masukkan perihal surat" required value="<?= isset($_POST['perihal']) ? htmlspecialchars($_POST['perihal']) : '' ?>">
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="4" placeholder="Tuliskan keterangan tambahan atau catatan penting..."><?= isset($_POST['keterangan']) ? htmlspecialchars($_POST['keterangan']) : '' ?></textarea>
                    </div>
