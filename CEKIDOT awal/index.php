...
$slides = $pdo->query("SELECT * FROM slider WHERE status='aktif' ORDER BY urutan LIMIT 6")->fetchAll();

$total_slides = max(3, count($slides));
?>

<style>
/* ============================================================
   RESET UNTUK SLIDER FULL
   ============================================================ */
html, body {
    margin: 0;
    padding: 0;
...
/* ============================================================
   LAYANAN SECTION - DESAIN PROFESIONAL
   ============================================================ */
.layanan-section {
    padding: 80px 0 90px;
    position: relative;
...
.layanan-section::after {
    ...
    background-image: 
        ...
        repeating-linear-gradient(45deg, 
            transparent, 
            transparent 30px, 
            rgba(15, 59, 94, 0.035) 30px, 
            rgba(15, 59, 94, 0.035) 31px
        ),
        repeating-linear-gradient(-45deg, 
            transparent, 
            transparent 30px, 
            rgba(234, 179, 8, 0.025) 30px, 
            rgba(234, 179, 8, 0.025) 31px
        ),
        radial-gradient(circle at 20% 40%, rgba(15, 59, 94, 0.04) 1px, transparent 1px),
        radial-gradient(circle at 70% 30%, rgba(234, 179, 8, 0.04) 1px, transparent 1px),
        radial-gradient(circle at 40% 70%, rgba(15, 59, 94, 0.03) 1px, transparent 1px),
        radial-gradient(circle at 85% 50%, rgba(234, 179, 8, 0.03) 1px, transparent 1px);
    background-size: 
        auto, auto, auto,
        60px 60px,
        60px 60px,
...
/* ============================================================
   SECTION HEADER - DESAIN BARU (TANPA TEKS LAYANAN)
   ============================================================ */
.section-header {
    text-align: center;
    margin-bottom: 50px;
...
.layanan-card::before {
    ...
    right: 0;
    bottom: 0;
    background: linear-gradient(135deg, rgba(15, 59, 94, 0.04), rgba(234, 179, 8, 0.04));
    pointer-events: none;
}
...
<section class="slider-section" id="homeSlider">
    <div class="slider-container" id="sliderContainer">
        ...
        <div class="slide active">
            <img src="assets/img/slide-1.jpg" alt="Default Slide">
        </div>
        <div class="slide">
            <img src="assets/img/slide-2.jpg" alt="Default Slide 2">
        </div>
        <div class="slide">
            <img src="assets/img/slide-3.jpg" alt="Default Slide 3">
        </div>
        <?php else: ?>
        <?php foreach($slides as $index => $slide): ?>
        <div class="slide <?= $index === 0 ? 'active' : '' ?>" data-index="<?= $index ?>">
            <img src="uploads/slider/<?= htmlspecialchars($slide['gambar']) ?>" alt="<?= htmlspecialchars($slide['judul']) ?>">
        </div>
        <?php endforeach; ?>
        <?php endif; ?>
    </div>
...
<section class="layanan-section">
    <div class="container">
        <!-- SECTION HEADER - DESAIN BARU PROFESIONAL -->
        ...
        <div class="layanan-grid">
            ...
            <!-- Card 1: Persuratan WFH -->
            <div class="layanan-card" onclick="window.location.href='kirim-surat.php'">
                ...
                <a href="kirim-surat.php" class="btn-layanan"><i class="fas fa-paper-plane"></i> Kirim</a>
            </div>

            <!-- Card 2: IKU -->
            <div class="layanan-card" onclick="window.location.href='iku.php'">
                ...
                <a href="iku.php" class="btn-layanan"><i class="fas fa-eye"></i> Lihat</a>
            </div>

            <!-- Card 3: AKIP -->
            <div class="layanan-card" onclick="window.location.href='akip.php'">
                ...
                <a href="akip.php" class="btn-layanan"><i class="fas fa-eye"></i> Lihat</a>
            </div>

            <!-- Card 4: IKI -->
            <div class="layanan-card" onclick="window.location.href='iki.php'">
                ...
                <a href="iki.php" class="btn-layanan"><i class="fas fa-eye"></i> Lihat</a>
            </div>

            <!-- Card 5: Capaian Program -->
            <div class="layanan-card" onclick="window.location.href='capaian.php'">
                ...
                <a href="capaian.php" class="btn-layanan"><i class="fas fa-eye"></i> Lihat</a>
            </div>

            <!-- Card 6: Monev -->
            <div class="layanan-card" onclick="window.location.href='monev.php'">
                ...
                <a href="monev.php" class="btn-layanan"><i class="fas fa-eye"></i> Lihat</a>
            </div>
