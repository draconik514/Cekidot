        ...
        <div class="footer-grid">
            <div class="footer-brand">
                <div class="footer-logo">
                    <div class="logo-icon">
                        <img src="{{ asset('assets/img/logo-sulteng.png') }}" alt="Logo Sulawesi Tengah" onerror="this.style.display='none';this.parentElement.innerHTML='<span style=\'font-size:18px;font-weight:900;color:#eab308;\'>S</span>'">
                    </div>
            ...
            <div class="footer-links">
                <h4>Layanan</h4>
                <ul>
                    <li><a href="{{ route('iku.public') }}">IKU</a></li>
                    <li><a href="{{ route('akip.public') }}">AKIP</a></li>
                    <li><a href="{{ route('iki.public') }}">IKI</a></li>
                    <li><a href="{{ route('monev.public') }}">Monev</a></li>
                    <li><a href="{{ route('surat.create') }}">Persuratan</a></li>
                    <li><a href="{{ route('capaian.public') }}">Capaian Program</a></li>
                </ul>
            </div>
