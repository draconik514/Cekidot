    ...
    <section class="iki-content">
        <div class="container">
            <div class="content-wrapper">
                ...
                {{-- Search & Filter --}}
                <form method="GET" action="{{ route('iki.public') }}" style="margin-bottom:20px">
                    ...
                    <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center">
                        ...
                        <button type="submit" style="padding:9px 20px;background:#0f3b5e;color:#fff;border:none;border-radius:8px;font-size:14px;cursor:pointer;font-family:inherit"><i class="fas fa-search"></i> Cari</button>
                        @if($search || $bulan || $tgl)
                        <a href="{{ route('iki.public') }}?tahun={{ $tahun_aktif }}" style="padding:9px 16px;background:#f1f5f9;color:#64748b;border-radius:8px;font-size:14px;text-decoration:none">Reset</a>
                        @endif
                    </div>
                </form>
