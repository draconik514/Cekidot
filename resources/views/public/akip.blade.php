...
@section('title', 'Daftar Dokumen AKIP - CEKIDOT')
...
<style>
    ...
    .akip-hero .hero-stats .stat { text-align: center; }
    .akip-hero .hero-stats .stat .number {
        font-size: 28px;
        font-weight: 800;
        color: #eab308;
        display: block;
    ...
    .akip-hero .hero-stats .stat .label {
        font-size: 11px;
        opacity: 0.6;
    ...
    @media (max-width: 992px) {
        .akip-hero .hero-content { flex-direction: column; align-items: flex-start; }
        .akip-hero .hero-stats { width: 100%; justify-content: center; }
        .akip-content .content-wrapper { padding: 24px 20px; }
    ...
    @media (max-width: 768px) {
        .akip-hero { padding: 30px 0 24px; }
        .akip-hero .hero-text h1 { font-size: 26px; }
        .akip-hero .hero-text p { font-size: 14px; }
        .akip-hero .hero-stats { padding: 10px 16px; gap: 16px; }
        .akip-hero .hero-stats .stat .number { font-size: 20px; }
        .akip-hero .hero-stats .stat .label { font-size: 10px; }
        .akip-content .content-wrapper { padding: 16px 12px; }
    ...
    @media (max-width: 480px) {
        .akip-hero .hero-text h1 { font-size: 22px; }
        .akip-hero .hero-stats { flex-wrap: wrap; gap: 12px; justify-content: center; }
        .akip-hero .hero-stats .stat { flex: 1; min-width: 50px; }
        .akip-hero .hero-stats .stat .number { font-size: 18px; }
...
@section('content')
<section class="akip-page">
    <section class="akip-hero">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    ...
                    <p>
                        Dokumentasi Akuntabilitas Kinerja Instansi Pemerintah. 
                        Transparansi, efisiensi, dan efektivitas dalam pelayanan publik.
                    </p>
                </div>
    ...
    <section class="akip-content">
        <div class="container">
            <div class="content-wrapper">
                <div class="filter-tahun">
                    <button class="btn-tahun" onclick="window.location.href='{{ route('akip.public') }}?tahun={{ $tahun_aktif - 1 }}'" {{ $tahun_aktif <= 2025 ? 'disabled' : '' }}>
                    ...
                    <div class="tahun-items">
                        @foreach($tahun_list as $t)
                            @php
                                $count = App\Models\DokumenAkip::where('tahun', $t)->where('status', 'aktif')->count();
                            @endphp
                            <a href="{{ route('akip.public') }}?tahun={{ $t }}" class="tahun-item {{ $t == $tahun_aktif ? 'active' : '' }}">
                                {{ $t }}
                    ...
                    <button class="btn-tahun" onclick="window.location.href='{{ route('akip.public') }}?tahun={{ $tahun_aktif + 1 }}'" {{ $tahun_aktif >= 2030 ? 'disabled' : '' }}>
                ...
                <div class="dokumen-grid">
                    ...
                    <div class="empty-state">
                        ...
                        <p>Belum ada dokumen AKIP yang tersedia untuk tahun {{ $tahun_aktif }}</p>
                    </div>
                    @else
                    @php $no = 1; @endphp
